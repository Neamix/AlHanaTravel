<section class="slider">
    <div id="slider" class="flexslider">
        <ul class="slides">
            <li>
                <img src="{{ asset('img/flex_slides/slide_1.jpg') }}" alt="">
                <div class="meta">
            ...
            <li>
                <img src="{{ asset('img/flex_slides/slide_2.jpg') }}" alt="">
                <div class="meta">
            ...
            <li>
                <img src="{{ asset('img/flex_slides/slide_3.jpg') }}" alt="">
                <div class="meta">
            ...
            <li>
                <img src="{{ asset('img/flex_slides/slide_4.jpg') }}" alt="">
                <div class="meta">
            ...
            <li>
                <img src="{{ asset('img/flex_slides/slide_5.jpg') }}" alt="">
                <div class="meta">
    ...
    <div id="carousel_slider_wp">
        <div id="carousel_slider" class="flexslider">
            <ul class="slides">
                <li>
                    <img src="{{ asset('img/flex_slides/slide_1_thumb.jpg') }}" alt="">
                    <div class="caption">
                ...
                <li>
                    <img src="{{ asset('img/flex_slides/slide_2_thumb.jpg') }}" alt="">
                    <div class="caption">
                ...
                <li>
                    <img src="{{ asset('img/flex_slides/slide_3_thumb.jpg') }}" alt="">
                    <div class="caption">
                ...
                <li>
                    <img src="{{ asset('img/flex_slides/slide_4_thumb.jpg') }}" alt="">
                    <div class="caption">
                ...
                <li>
                    <img src="{{ asset('img/flex_slides/slide_5_thumb.jpg') }}" alt="">
                    <div class="caption">
