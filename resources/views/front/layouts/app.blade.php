				...
				<ul>
					<li><span><a href="#0">Home</a></span>
						<ul>
							...
							<li>
								<span><a href="#0">Sliders - Parallax <strong class="badge badge-danger">New!</strong></a></span>
								<ul>
							...
							<li><a href="index-17.html">Text Rotator <strong class="badge badge-danger">New!</strong></a></li>
