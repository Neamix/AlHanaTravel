...
<body>
    <header class="header menu_fixed">
        ...
        <ul id="top_menu">
            <li><a href="cart-1.html" class="cart-menu-btn" title="Cart"><strong></strong></a></li>
            <li><a href="#sign-in-dialog" id="sign-in" class="login" title="Sign In"></a></li>
            <li><a href="wishlist.html" class="wishlist_bt_top" title="Your wishlist"></a></li>
        </ul>
        <!-- /top_menu -->
            ...
            <ul>
                <li><span><a href="#0">Home</a></span>
                    <ul>
                        ...
                        <li><a href="index-10.html">Search 3 <strong>New!</strong></a></li>
                ...
                <li><span><a href="#0">Tours</a></span>
                    <ul>
                        ...
                        <li><a href="detail-working-contact-form.html">Detail Contact Form</a></li>
                        <li>
                ...
                <li><span><a href="#0">Pages</a></span>
                    <ul>
                        ...
                        <li><a href="bootstrap-modal.html">Bootstrap Modal</a></li>
                        <li><a href="modal-version-2.html">Another Modal</a></li>
                        <li><a href="pricing-tables-2.html">Pricing Tables 1</a></li>
                        <li><a href="pricing-tables-3.html">Pricing Tables 2</a></li>
                    </ul>
                </li>
